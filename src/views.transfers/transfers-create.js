...
const iconbrand = require('../media/emrok.png')
  ...
  <>
    ...
    <ContentFormat 
      ...
      header = {{ size: 'mini', visible: true, data: 
        <> 
          <div className="text-center back-color-lite d-none d-md-block">
            <WebbHeader data = {{
              name: metadata.name,
              link: 'home'
            }}/>
          </div>
          <div className="text-center back-color-lite d-block d-md-none">
            <WebbDividerSmall />
            <img className="" src={iconbrand} height={33}></img>
            <WebbDividerSmall />
          </div>
